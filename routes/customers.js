...
exports.edit = function (req, res) {
    ...
    pool.query('SELECT * FROM customer WHERE id=$1', [id], function (err, result) {
        if (err) {
            console.log(err);
            res.status(400).send(err);
        }
...
exports.save = function (req, res) {
    ...
    pool.query('INSERT INTO customer(name, address, email, phone) VALUES($1, $2, $3, $4) RETURNING *', cols, function (err, result) {
        if (err) {
...
exports.update = function (req, res) {
    ...
    pool.query('UPDATE customer SET name=$1, address=$2,email=$3, phone=$4 WHERE id=$5', cols, function (err, result) {
        if (err) {
...
exports.delete = function (req, res) {
    ...
    pool.query("DELETE FROM customer WHERE id=$1", [id], function (err, rows) {
        if (err) {
